        ...
        <div className='border rounded w-full flex flex-col gap-8 items-center p-2'>
            <div className='flex '>
                ...
                <div className=''>
                    ...
                    <p className='w-1/2 text-gray-700'>Repo description: Lorem ipsum, dolor sit amet consectetur adipisicing elit. Vel quibusdam ea perspiciatis hic eius non eos ullam, harum natus ipsa laborum, vitae molestias rerum deserunt soluta quos beatae? Corrupti, ex?</p>
                </div>
            </div>
            <div>
